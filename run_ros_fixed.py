...
opts = [vanilla_l2o, sparse_tel, sparse_tel_theta_grad, theta_grad, Adam_Opt(lr=0.3)]

# test L2O optimizers
times, losses, grad_norms, iter_arrs = test_opts(opts, task_dist, test_runs, test_epochs)

#Plot Losses and Gradient Norms vs Epochs
labels = ["vanilla l2o", "tel sched", "tel sched + input theta grad", "input theta grad", "Adam"]
plot_all(times, losses, grad_norms, labels, n_epoch=test_epochs, xticks=[0,5,10], loc='ros_fixed_figs')
...
labels = [["vanilla l2o", ""], \
            ...
            ["Adam", ""]]
plot_trajectories(iter_arrs, task_dist, labels, loc='ros_fixed_figs')