...
plot_all(times, losses, grad_norms, labels, n_epoch=test_epochs, xticks=[0,5,10], loc='ros_vary_figs')
...
labels = [["vanilla l2o", ""], \
            ...
            ["Adam", ""]]
plot_trajectories(iter_arrs, task_dist, labels, loc='ros_vary_figs')