...
plot_all(times, losses, grad_norms, labels, n_epoch=test_epochs, xticks=[0,5,10], loc='elli_fixed_figs',ylim=0.5)
...
plot_trajectories(iter_arrs, task_dist, labels, loc='elli_fixed_figs')

# TODO:
# add vanilla L2O to the figures
# GD w/ learned teleport
# Adam w/ learned teleport
# the above with line search?